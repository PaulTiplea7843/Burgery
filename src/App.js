...
function App() {
  ...
  const orderWaitingIdSaved = localStorage.getItem("orderWaitingId");
  ...
  const [orderWaitingId, setOrderWaitingId] = useState(
    orderWaitingIdSaved ? orderWaitingIdSaved : ""
  );
          ...
          <Router>
            ...
            <Switch>
              ...
              <Route path="/orderwaiting">
                <OrderWaiting
                  orderWaitingId={orderWaitingId}
                  setOrderWaitingId={setOrderWaitingId}
                />
              </Route>
